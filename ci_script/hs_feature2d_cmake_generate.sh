...
. ${CI_PROJECT_DIR}/ci_script/hslib_ci_script/resolve_dependency.sh \
  --submodules "ALL" --deps "gtest jpeg_turbo zlib png tiff" "yong" "hs_image_io"
...
. ${CI_PROJECT_DIR}/ci_script/hslib_ci_script/cmake_generate.sh \
  --extra_cmake_defs "-DHSLIB_COPY_TEST_DATA=1" --deps "gtest jpeg_turbo zlib png tiff hs_image_io"
