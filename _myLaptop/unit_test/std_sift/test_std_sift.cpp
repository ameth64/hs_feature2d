...
using namespace hs::feature2d;

class TestImageHelper
{
public:
  TestImageHelper(const std::string& path,
...
TEST(TestImageHelper, ReadTest)
{
  ...
  TestImageHelper jpg_channel_3_tester(
    image_path, width, height, channel, bit_depth, color_type, 5);
  ASSERT_EQ(TestImageHelper::TR_SUCCESS, jpg_channel_3_tester.Test());
  ...
  TestImageHelper jpg_channel_4_tester(
    image_path, width, height, channel, bit_depth, color_type, 5);
  ASSERT_EQ(TestImageHelper::TR_SUCCESS, jpg_channel_4_tester.Test());
}
